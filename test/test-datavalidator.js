(function() {
  ...
  //var dv = require(__dirname + '/../models/datavalidator');
  ...
  //describe('DataValidator.validate', function(){
    ...
    //it('should throw an error if a property is present and has a validator ' +
      //'which isn\'t a boolean function or null', 
      //function(){
        //(function(){
          //dv.validate({
            //prop : 'value'
